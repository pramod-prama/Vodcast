...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        # Replace line 205 (approximately):
        # OLD: imageio.mimsave(path, result,  fps=float(25))
        # NEW:
        imageio.mimsave(path, result, fps=25, format='FFMPEG', codec='libx264')
        ...
        if enhancer:
            ...
            try:
                ...
                # Also replace the similar lines later in the code (around lines 230-235):
                # OLD: imageio.mimsave(enhanced_path, enhanced_images_gen_with_len, fps=float(25))
                # NEW:
                imageio.mimsave(enhanced_path, enhanced_images_gen_with_len, fps=25, format='FFMPEG', codec='libx264')
            except:
